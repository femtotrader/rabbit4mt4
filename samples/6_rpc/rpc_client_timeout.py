...
class FibonacciRpcClient(object):
    def __init__(self, host, username, password, queue, timeout):
...
@click.option('--timeout', default=2, help='n')
def main(host, username, password, queue, n, timeout):
    fibonacci_rpc = FibonacciRpcClient(host, username, password, queue, timeout)
