...
//extern string g_rabbitmq_routingkey_root_setting = "mt5_demo01_123456"; //RabbitMQ bindingkey_root use password generator to give a unique name
// terminal_id_setting